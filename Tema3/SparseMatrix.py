class SparseMatrix:
    ...
    def multiply_matrix_efficient(self,B):
        ...
        line_index = 0
        B_line_indexes = self.compute_line_indexes(B.val_col) #compute the line indexes before, a little bit more efficient
        # For each line
        ...
        while line_index < vc_length - 1:
            ...
            for col in valid_columns:
                ...
                for line_element_index in xrange(line_start,line_end):
